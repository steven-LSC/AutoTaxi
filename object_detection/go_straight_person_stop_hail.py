...
try:
    ...
    for frame1 in camera.capture_continuous(rawCapture, format="bgr",use_video_port=True):
        ...
        # 判斷如果是人的相似度大於0.6 同時大於畫面高度的0.6就拍照 並儲存到AutoTaxi跟openpose
        if (boxes[0][person_sc_index][2]-boxes[0][person_sc_index][0]) > 0.6 and sc[person_sc_index] > 0.6:
            ...
            print("capture")
            # 拍照
            camera.capture('/home/pi/Desktop/openpose-master/examples/media/target.jpg')
